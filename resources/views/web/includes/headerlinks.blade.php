<head>
    ...
    <meta property="og:image" content="{{ asset('assets/img/vaanam-og.jpg', true) }}" />
    <meta property="og:image:secure_url" content="{{ asset('assets/img/vaanam-og.jpg', true) }}" />
    ...
    <meta name="twitter:image" content="{{ asset('assets/img/vaanam-og.jpg', true) }}" />
