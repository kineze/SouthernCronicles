      ...
      <section v-for="group in groups" :key="group.key">
        ...
        >
          <div
            ...
            class="text-black font-semibold px-3 lg:w-3/12 sm:w-2/12  cursor-pointer transition duration-300 hover:bg-black hover:text-white overflow-hidden flex flex-col items-start h-full max-w-xs w-full"
          >
