      ...
      @include('web.includes.nav')
        ...
        @yield('content')
          ...
          @if (!Route::is('volunteerWithUs'))
            <a href="{{ route('volunteerWithUs') }}" class="animate-fade-up border border-white hidden fixed bottom-6 right-6 z-[1000] bg-black text-white lg:inline-flex items-center justify-center rounded-full shadow-lg hover:bg-black hover:text-white transition-all duration-500 px-4 py-2">
              <i class="fa-solid fa-hand-holding-heart mr-3 text-xl"></i>
