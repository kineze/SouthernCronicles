         ...
         <div  class=" relative flex pb-24 flex-wrap bg-white z-[1000] bg-opacity-30 backdrop-blur-xl rounded-3xl  bg-transparent items-start justify-end lg:px-12 pt-12 lg:pt-36">
           <div class="w-full lg:w-6/12">
            ...
            <h2 class="font-semibold tracking-[10px] text-black text-center md:text-start uppercase text-xl">Brussels.</h2>
                ...
                <p class="text-gray-700  text-justify py-3">Whether you hail from East or West, North or South, this is your space.</p>
                <p class="text-gray-700   text-justify py-3">The Asian Literary Festivals don't just showcase literature—they celebrate the full spectrum of human creativity and connection, and each festival is proudly local in its international network.</p>
                <p class="text-gray-700   text-justify py-3">Join us in writing the next chapter of global literary dialogue, where every story matters and every voice contributes to our collective human narrative. The Asian Literary Festival, Brussels Edition, co-created by The Asian/Trogon festival ecosystem and The Philippine Art and Culture Exchange (PACe), weaves creative expression from the global majority into this vibrant tapestry, transforming the European capital into an unparalleled sanctuary of cultural exchange and cross-fertilisation.</p>
                <p class="text-gray-700   text-justify py-3">This festival revives the historical exchanges between East and West, breathing new life into ancient dialogues as literary traditions converge and contemporary voices rise, creating a dynamic crossroads where stories transcend borders and new cultural conversations bloom in this remarkable intersection of civilisations.</p>
            </div>
           </div>
        </div>
    </div>
