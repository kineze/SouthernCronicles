  ...
  <div class="flex pr-4 items-center">
     <button id="toggleSidebar"
          class="flex items-center justify-center h-9 w-9 rounded-full
                 bg-white dark:bg-slate-800 shadow border border-gray-200 dark:border-slate-700
                 text-gray-600 dark:text-gray-200 transition hover:bg-gray-100 dark:hover:bg-slate-700"
