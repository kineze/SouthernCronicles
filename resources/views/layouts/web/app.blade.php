      ...
      @include('web.includes.nav')
        ...
        @yield('content')
          ...
          @if (!Route::is('writingLab'))
            <a href="{{ route('writingLab') }}" class="animate-fade-up hidden lg:flex fixed bottom-6 right-6 z-[1000] text-white px-5 py-5 rounded-full shadow-lg hover:bg-black hover:text-white transition-all duration-500">
