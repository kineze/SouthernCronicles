<template>
    <div class="py-8" >
        <div class="px-4 py-3 bg-black">
            <h1 class="lg:text-4xl text-3xl mt-12 lg:mt-4 text-white font-extrabold tracking-widest uppercase text-center">Stage, Page, Revolution: The Future of Storytelling Starts Here</h1>
        </div>
