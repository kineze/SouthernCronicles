      ...
      <div >
         ...
         <div class="flex w-full flex-wrap justify-center py-6 px-3">
            ...
            <div class="w-full lg:w-6/12 text-gray-700 dark:text-gray-300 pr-6 space-y-5">
                ...
                <h2 class="lg:text-4xl text-3xl mt-12 lg:mt-4 text-black font-extrabold tracking-widest uppercase text-left">පැදුර</h2>
                <p>
                    <strong class="text-lg text-black text-justify dark:text-white">සාහිත්‍යය පිළිබඳ ගැඹුරු සාකච්ඡා</strong>
                </p>
