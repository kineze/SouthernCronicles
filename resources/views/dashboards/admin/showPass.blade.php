...
<div class="w-full p-6 py-4 mx-auto my-4">
    <div class="flex flex-wrap -mx-3">
      <div class="w-full max-w-full px-3 mx-auto sm:flex-0 shrink-0 sm:w-10/12 md:w-6/12">
          <div class="relative flex flex-col min-w-0 break-words bg-white border-0 dark:bg-gray-800 dark:shadow-soft-dark-xl shadow-soft-xl rounded-2xl bg-clip-border sm:my-12">
