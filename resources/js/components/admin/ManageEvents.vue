    ...
    <td class="px-6 py-4 dark:text-white">
      ...
      <span v-else class="text-gray-400 italic">N/A</span>
        ...
        <td class="px-6 py-4 flex justify-end gap-3 text-right">
          <button @click="editEvent(event)" class="text-green-500" title="Edit">
...
.floating-input {
  @apply block px-2.5 pb-2.5 pt-4 w-full text-sm text-gray-900 bg-transparent rounded-lg border border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-green-500 focus:outline-none focus:ring-0 focus:border-green-600;
}
