...
@section('content')
<div class="w-full p-3 mx-auto my-3">
    <div class="flex flex-wrap mb-12 -mx-3">
        <div class="w-full max-w-full px-3 lg:flex-0 shrink-0 lg:w-3/12">
            <div class="sticky flex flex-col min-w-0 break-words bg-white border-0 top-1/100 dark:bg-gray-800 dark:shadow-soft-dark-xl shadow-soft-xl rounded-2xl bg-clip-border">
        ...
        <div class="w-full max-w-full px-3 lg:flex-0 shrink-0 lg:w-9/12">
            <div class="relative flex flex-col flex-auto min-w-0 p-4 break-words bg-white border-0 dark:bg-gray-800 dark:shadow-soft-dark-xl shadow-soft-xl rounded-2xl bg-clip-border" id="profile">
            ...
            <div class="relative flex flex-col min-w-0 mt-6 break-words bg-white border-0 dark:bg-gray-800 dark:shadow-soft-dark-xl shadow-soft-xl rounded-2xl bg-clip-border" id="basic-info">
                <div class="flex-auto pt-0">
                    <form class="relative" id="user-data"  action="{{route( 'updateUser', $user->id )}}" method="post">
                        ...
                        <div active form="info" class="
                            flex flex-col visible w-full h-auto min-w-0 first-letter:break-words bg-white border-0 opacity-100 dark:bg-gray-800 rounded-2xl bg-clip-border">
                            <div class="flex-auto p-6">
                                ...
                                <div class="flex-auto mt-3">
                                    ...
                                    <div class="flex justify-between gap-y-2 flex-wrap h-fit w-full">
                                        ...
                                        <div class="pr-2 flex w-full lg:w-4/12">
                                            <div class="w-full relative {{ $errors->has('roles') ? 'border-red-500' : 'border-gray-300' }} flex flex-col h-fit bg-white  dark:text-white p-5 dark:border-gray-600 dark:bg-gray-850 rounded-lg border-0.4 border-gray-300 w-full cursor-pointer">
                                                <label class="">
                                                    <input id="checkbox-{{$role->id}}" name="roles[]" value="{{$role->name}}" {{ in_array($role->name, $userRoles) ? 'checked' : '' }} class="w-5 h-5 text-blue-600 bg-gray-100 border-gray-300 rounded-xl focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" type="checkbox" />
                                ...
                                <button type="submit" href="javascript:;" class="inline-block float-right px-8 py-2 mt-16 mb-0 font-bold text-right text-white uppercase align-middle transition-all border-0 rounded-lg cursor-pointer hover:scale-102 active:opacity-85 hover:shadow-soft-xs dark:bg-gradient-to-tl dark:from-blue-600 dark:to-cyan-400 bg-gradient-to-tl from-blue-700 to-cyan-500 leading-pro text-xs ease-soft-in tracking-tight-soft shadow-soft-md bg-150 bg-x-25">Update User</button>
            ...
            <div class="relative flex flex-col min-w-0 mt-6 break-words bg-white border-0 dark:bg-gray-800 dark:shadow-soft-dark-xl shadow-soft-xl rounded-2xl bg-clip-border" id="password">
                <div class="p-6">
                    ...
                    <form class="relative" id="password-reset"  action="{{ route('updateUserPassword', $user->id ) }}" method="POST">
                        ...
                        <div class="flex flex-wrap mt-6 -mx-3">
                            <!-- Password -->
                            <div class="w-full max-w-full px-3 mt-6 flex-0 sm:mt-0">
                                <div class="relative z-0">
                        ...
                        <div class="flex flex-wrap -mx-3">
                            <div class=" w-full max-w-full px-3 mt-4 flex-0 sm:mt-0">
                                <label class="mt-3">
                                    ...
                                    <label for="send-password-email" class="cursor-pointer dark:text-gray-200 select-none text-slate-700">notify user Via Email? (this will send password to the user)</label>
                                </label>
                            </div>
                        </div>
                            ...
                            <button type="submit" class="inline-block float-right px-8 py-2 mt-16 mb-0 font-bold text-right text-white uppercase align-middle transition-all border-0 rounded-lg cursor-pointer hover:scale-102 active:opacity-85 hover:shadow-soft-xs dark:bg-gradient-to-tl dark:from-blue-600 dark:to-cyan-400 bg-gradient-to-tl from-blue-700 to-cyan-500 leading-pro text-xs ease-soft-in tracking-tight-soft shadow-soft-md bg-150 bg-x-25">Update Password</button>
                        </div> 
                    </form>  
                </div>
            </div>
