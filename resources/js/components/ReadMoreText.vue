...
const contentBlocks = [
  ...
  },
  {
    ...
    Through strategic partnerships with prestigious institutions such as the Université Libre de Bruxelles and the Philippine Embassy in Belgium, PACe orchestrates a diverse array of cultural initiatives that celebrate the richness of Filipino identity. The organisation's programming encompasses everything from compelling exhibitions exploring the Filipino diaspora experience to vibrant celebrations like Philippine Food Month, creating platforms that honour both traditional customs and contemporary artistic expressions.
